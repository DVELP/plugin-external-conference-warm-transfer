...
class ConferenceService {
  ...
  _toggleParticipantHold = (conference, participantSid, hold) => {
    return new Promise((resolve, reject) => {
      ...
      return fetch(
        `https://${this.serviceBaseUrl}/ext-trans-hold-conference-participant`,
        {
          headers: {
  ...
  setEndConferenceOnExit = (
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(
        `https://${this.serviceBaseUrl}/ext-trans-update-conference-participant`,
        {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded"
          },
  ...
  addParticipant = (taskSid, from, to) => {
    return new Promise((resolve, reject) => {
      ...
      fetch(
        `https://${this.serviceBaseUrl}/ext-trans-add-conference-participant`,
        {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded"
          },
  ...
  removeParticipant = (conference, participantSid) => {
    return new Promise((resolve, reject) => {
      ...
      fetch(
        `https://${this.serviceBaseUrl}/ext-trans-remove-conference-participant`,
        {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded"
          },
